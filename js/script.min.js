...
jQuery(function($) {
    ...
    $("#portfolio").on("click", ".folio-read-more", function(event) {
        ...
        var full_url = "#portfolio-single-wrap", parts = full_url.split("#"), trgt = parts[1], target_top = $("#" + trgt).offset().top;
        $("html, body").animate({
    ...
    $("#portfolio-single-wrap").on("click", ".close-folio-item", function(event) {
        event.preventDefault();
        var full_url = "#portfolio", parts = full_url.split("#"), trgt = parts[1], target_offset = $("#" + trgt).offset(), target_top = target_offset.top;
        $("html, body").animate({
            scrollTop: target_top
        }, 600);
    ...
    form.submit(function(event) {
        ...
        $.ajax({
            ...
            form_status.html('<p class="text-success">Thank you for contact us. As early as possible  we will contact you</p>').delay(3e3).fadeOut();
        });
    });
    //Google Map
    var latitude = $("#google-map").data("latitude");
